...
from pytorch_hebbian.learning_rules import FristonsRule
...
def main(args: Namespace, params: dict, dataset_name, run_postfix=""):
    ...
    run = '{}/FEP/{}'.format(dataset_name, identifier)
    if run_postfix:
        run += '-' + run_postfix
    ...
    learning_rule = FristonsRule(state_prior=params['state_prior'], normalize=True)
